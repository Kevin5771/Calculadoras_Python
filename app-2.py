...
tasas_conversion = {
    ...
    'JPY': {'USD':0.0091,'EUR':0.0077, 'GB':0.0068}
}

#Función calculadora de divisas
...
ventana= tk.Tk()
ventana_title=("Calcular Divisas")

#Crear etiquetas y colocarlas en cuadricaula
